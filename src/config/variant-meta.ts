...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  silkroad: {
    title: 'Silk Road Intel — MENA-China Trade Bridge',
    description: 'Market intelligence and transaction facilitation between Arab importers and Chinese suppliers. Real-time commodity prices, shipping routes, factory capacity, halal compliance, sanctions risk, and trade policy — all in one view.',
    keywords: 'MENA China trade, Arab importer, China supplier, commodity prices, shipping routes, Hormuz, Suez, halal trade, Gulf economies, OPEC, trade corridor, sourcing intelligence, factory data, sanctions monitor, market maker',
    url: 'https://intel.silkroadleo.com/',
    siteName: 'Silk Road Intel',
    shortName: 'SilkRoad',
    subject: 'MENA-China Trade Corridor Intelligence & Transaction Facilitation',
    classification: 'Trade Intelligence Dashboard, Sourcing Platform, Market Maker',
    categories: ['business', 'finance'],
    features: [
      'Live commodity price tracking (metals, energy, agri)',
      'MENA-China shipping route & chokepoint monitoring',
      'China factory capacity & export data',
      'Halal certification & food trade intelligence',
      'Gulf & OPEC economy signals',
      'Sanctions, tariffs & compliance risk',
      'Base metals & critical minerals supply map',
      'AIS vessel tracking (tankers, bulk carriers)',
      'Trade policy & regulatory alerts',
      'Market maker: connect importers to suppliers',
    ],
  },
  full: {
